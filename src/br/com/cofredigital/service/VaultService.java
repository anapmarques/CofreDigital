...
public class VaultService {
    ...
    public void listVaultFilesInteractive() throws Exception {
        File idxEnc = new File("vault/Files/index.enc");
        File idxAsd = new File("vault/Files/index.asd");
        ...
        byte[] master = Files.readAllBytes(new File("vault/Files/index.env").toPath());
